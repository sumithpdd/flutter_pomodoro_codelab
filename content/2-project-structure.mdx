...
stepNo: 2
metaTitle: Pomodoro codelab - Project Structure page
metaDescription: Pomodoro codelab - Project Structure page description
...
Once you download the starter code for the 🚧 project , and open it in your favourite editor (VSCode), you will see some 📄 files
we have here
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'devfest - 2022 - Pomodoro app workshop',
      theme: ThemeData(
