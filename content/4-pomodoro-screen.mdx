...
Lets start building the **Pomodoro screen**

for Pomodoro we need messages, we will create a model for messages , Create a new 📄 file under models 📁 folder  => **`message.dart`**
